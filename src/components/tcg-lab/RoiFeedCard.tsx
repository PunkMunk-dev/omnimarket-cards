...
import type { TopRoiCard, HotnessLabel } from '@/hooks/useTopRoi';

interface RoiFeedCardProps {
  card: TopRoiCard;
  hotness: HotnessLabel | null;
  rank: number;
}

export function RoiFeedCard({ card, hotness, rank }: RoiFeedCardProps) {
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
          ...
          {hotness && <HotBadge label={hotness} size="xs" />}
        </div>
      </div>
